...
export const BRAIN_CORPUS: BrainNote[] = [
  ...
  note({
    ...
    businessId: "dojozeus",
    project: "lyceum",
    title: "Founding 35 at $59.99, then $149",
    body: "Founding: $59.99/mo or $599/yr, first 35 schools, rate locked while continuously subscribed. Standard: $149/mo or $1,490/yr. Zeus runs the office. Ares tutors. DojoZeus schools are all-inclusive and rank as Academy for plan gates. Talk to owners, not instructors who cannot buy.",
    kind: "decision",
    tags: ["pricing", "offer"],
    date: "2026-07-20",
  }),
  ...
  note({
    ...
    body: "Owners do not object to the fee. They object to “we just signed for a year.” Sit beside them until the contract ends. Founding $59.99 holds if they claim a seat now. Zen Planner public outages are a moment to engage commenters, not dunk.",
    kind: "competitor",
